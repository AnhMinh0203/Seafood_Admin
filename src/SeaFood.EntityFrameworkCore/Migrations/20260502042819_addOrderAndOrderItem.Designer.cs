...
namespace SeaFood.Migrations
{
    ...
    [Migration("20260502042819_addOrderAndOrderItem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeaFood.Entities.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SeaFood.Entities.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SeaFood.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SeaFood.Entities.ContactRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("InterestedProduct")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SeaFood.Entities.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SeaFood.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SeaFood.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SeaFood.Entities.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SeaFood.Entities.OrderItem", b =>
                {
                    b.HasOne("SeaFood.Entities.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("SeaFood.Entities.Product", b =>
                {
                    b.HasOne("SeaFood.Entities.Category", "Category")
                        .WithMany("Products")
